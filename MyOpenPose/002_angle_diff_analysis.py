...
def main():
    input_csv = "table/angle_offset_table.csv"
    output_dir = "output"
    ...
    high_angle_diff_path =  "table/high_angle_diff_joints.csv"
    ...
    plot_frame_average_difference(angle_matrix, save_path=os.path.join(output_dir, "frame_average_difference.png"))
    plot_joint_average_difference(angle_matrix, save_path=os.path.join(output_dir, "joint_average_difference.png"))
    cluster_frames_by_angles(angle_matrix, n_clusters=3, save_path=os.path.join(output_dir, "frame_clustering.png"))
